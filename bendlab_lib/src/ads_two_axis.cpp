 ...
 *				executes callback registered in
 *ads_two_axis_init. This function is called from ads_two_axis_hal. Application
 ...
 *both AXES. ADS_CALIBRATE_FLAT can be at 45 - 255 degrees, recommended 90
 *degrees. When calibrating the flat axis the perpendicular axis should be at 0
 *degrees. ADS_CALIBRATE_PERP can be at 45 - 255 degrees, recommended 90
 *degrees. When calibrating the perpendicular axis the flat axis should be at 0
 *degrees
 *
 *				Note:	The flat axis is sample[0] (axis 0) perp
 *axis is sample[1] (axis 1) from ads_data_callback
 *
 ...
 *				ADS_AXIS_0_EN enables axis zero and disables axis
 *one ADS_AXIS_1_EN enables axis one and disables axis zero
 *
