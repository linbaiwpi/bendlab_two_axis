...
#define ADS_DFU_CHECK                                                          \
  (1) // Set this to 1 to check if the newest firmware is on the ADS
 ...
 *degrees
 *
 *				Note:	The flat axis is sample[0] perp axis is
 *sample[1] from ads_data_callback
 *
