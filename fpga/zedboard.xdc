...
set_property PACKAGE_PIN Y10  [get_ports {iic_ad7746_scl_io}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {iic_ad7746_sda_io}];  # "JA4"
set_property PULLUP TRUE [get_ports iic_ad7746_scl_io]
set_property PULLUP TRUE [get_ports iic_ad7746_sda_io]
...
set_property PACKAGE_PIN W12 [get_ports {intr_bl}];  # "JB1"
set_property PACKAGE_PIN V10 [get_ports {iic_bl_scl_io}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {iic_bl_sda_io}];  # "JB4"
...
set_property PACKAGE_PIN AB6 [get_ports {reset_tri_io[0]}];  # "JC1_N"
set_property PACKAGE_PIN AB7 [get_ports {reset_tri_io[1]}];  # "JC1_P"
set_property PACKAGE_PIN AA4 [get_ports {reset_tri_io[2]}];  # "JC2_N"
set_property PACKAGE_PIN Y4  [get_ports {reset_tri_io[3]}];  # "JC2_P"
set_property PACKAGE_PIN T6  [get_ports {reset_tri_io[4]}];  # "JC3_N"
set_property PACKAGE_PIN R6  [get_ports {reset_tri_io[5]}];  # "JC3_P"
set_property PACKAGE_PIN U4  [get_ports {reset_tri_io[6]}];  # "JC4_N"
set_property PACKAGE_PIN T4  [get_ports {reset_tri_io[7]}];  # "JC4_P"
...
set_property PACKAGE_PIN T22 [get_ports {gpio_io_o_0_tri_o[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {gpio_io_o_0_tri_o[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {gpio_io_o_0_tri_o[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {gpio_io_o_0_tri_o[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {gpio_io_o_0_tri_o[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {gpio_io_o_0_tri_o[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {gpio_io_o_0_tri_o[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {gpio_io_o_0_tri_o[7]}];  # "LD7"
