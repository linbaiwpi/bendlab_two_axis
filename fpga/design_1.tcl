...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0  [get_bd_pins LMB_Clk] \
...
proc create_root_design { parentCell } {
  ...
  set iic_ad7746 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 iic_ad7746 ]
  ...
  set iic_bl [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 iic_bl ]

  set reset [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 reset ]

  set gpio_io_o_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 gpio_io_o_0 ]


  # Create ports
  set intr_bl [ create_bd_port -dir I -from 0 -to 0 intr_bl ]
  ...
  # Create instance: iic_ad7746, and set properties
  set iic_ad7746 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_iic:2.1 iic_ad7746 ]
...
\
  ...
  # Create instance: iic_bendlab, and set properties
  set iic_bendlab [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_iic:2.1 iic_bendlab ]
  set_property CONFIG.IIC_FREQ_KHZ {400} $iic_bendlab
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports reset] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports gpio_io_o_0] [get_bd_intf_pins axi_gpio_1/GPIO]
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports iic_ad7746] [get_bd_intf_pins iic_ad7746/IIC]
  connect_bd_intf_net -intf_net axi_iic_1_IIC [get_bd_intf_ports iic_bl] [get_bd_intf_pins iic_bendlab/IIC]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_intc_0_interrupt] [get_bd_intf_pins microblaze_0/INTERRUPT] [get_bd_intf_pins system_ila_0/SLOT_0_MBINTERRUPT]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins iic_ad7746/S_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins iic_bendlab/S_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ps7_0_axi_periph/M04_AXI] [get_bd_intf_pins axi_intc_0/s_axi]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins ps7_0_axi_periph/M05_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins ps7_0_axi_periph/M06_AXI] [get_bd_intf_pins axi_gpio_1/S_AXI]

  # Create port connections
  connect_bd_net -net In1_0_1  [get_bd_ports intr_bl] \
  [get_bd_pins xlconcat_0/In1] \
  [get_bd_pins system_ila_0/probe1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets In1_0_1]
  ...
  [get_bd_pins iic_ad7746/s_axi_aclk] \
  [get_bd_pins iic_bendlab/s_axi_aclk] \
  ...
  connect_bd_net -net rst_ps7_0_100M_bus_struct_reset  [get_bd_pins rst_ps7_0_100M/bus_struct_reset] \
  ...
  [get_bd_pins iic_ad7746/s_axi_aresetn] \
  [get_bd_pins iic_bendlab/s_axi_aresetn] \
  ...
  assign_bd_address -offset 0x41600000 -range 0x00010000 -with_name SEG_axi_iic_0_Reg -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs iic_ad7746/S_AXI/Reg] -force
  assign_bd_address -offset 0x41610000 -range 0x00010000 -with_name SEG_axi_iic_1_Reg -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs iic_bendlab/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] -force
  assign_bd_address -offset 0x41600000 -range 0x00010000 -with_name SEG_axi_iic_0_Reg -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs iic_ad7746/S_AXI/Reg] -force
  assign_bd_address -offset 0x41610000 -range 0x00010000 -with_name SEG_axi_iic_1_Reg -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs iic_bendlab/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x42C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
